...
class Livraison(models.Model):
    ...
    heure_depart = models.fields.CharField(null=True, blank=True, max_length=100, choices= choiceheures)
    ...
    details_commande = models.FileField(null=True, blank=True,)
    commentairedispatch = models.fields.CharField(null=True, blank=True, max_length=500000)
    ...
    recuperation = models.fields.CharField(null=True, blank=True, max_length = 3, choices=choices, default="non")
    status = models.BooleanField(default=False)
    adress = models.fields.CharField(null=True, blank=True, max_length=700)
